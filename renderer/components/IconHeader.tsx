...
function IconHeader({ menu }) {
  ...
  if (menu === "Study Data") {
    icon = (
      <svg
        ...
        className="w-6 h-6 mx-1 sm:w-7 sm:h-7 bi bi-person-bounding-box pt-1 pl-2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor">
  ...
  } else if (menu === "Hazard Type") {
    icon = (
        <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-6 h-6 mx-1 sm:w-7 sm:h-7 bi bi-journals pt-1 pl-2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor">
  ...
  } else if (menu === "PHA Worksheet") {
    icon = (
        <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-6 h-6 mx-1 sm:w-7 sm:h-7 bi bi-file-ruled pt-1 pl-2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor">
  ...
  } else if (menu === "Recommendation") {
    icon = (
        <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-6 h-6 mx-1 sm:w-7 sm:h-7 bi bi-list-ol pt-1 pl-2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor">
  ...
  } else if (menu === "Safeguard") {
    icon = (
        <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-6 h-6 mx-1 sm:w-7 sm:h-7 bi bi-shield-shaded pt-1 pl-2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor">
  ...
  } else if (menu === "Risk Matrix") {
    icon = (
        <svg
        xmlns="http://www.w3.org/2000/svg"
        className="w-6 h-6 mx-1 sm:w-7 sm:h-7 bi bi-box-fill pt-1 pl-2"
        fill="none"
        viewBox="0 0 24 24"
        stroke="currentColor">
