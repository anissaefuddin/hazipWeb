...
const NodesPage: React.FC = () => {
  ...
  const handleAddRow = () => {
    ...
    newNodes.Deviations[0].Causes[0].Consequences[0].Pha_Recommendation_IDs = [
  ...
  const handleDesignConditionChange = (
    e: React.ChangeEvent<HTMLInputElement>,
    index: number,
  ) => {
    const updatedNodes = [...nodes];
  ...
  const handleOperatingConditionChange = (
    e: React.ChangeEvent<HTMLInputElement>,
    index: number,
  ) => {
    const updatedNodes = [...nodes];
        ...
        <div className="container">
          <div className="row">
            ...
            <div>
              ...
              <ButtonExportExcelNode
              DataJson={nodes}
              NameFile={"Export_HazardType"}
            />
            </div>
            {showError && (
              <div
                  ...
                  >
                    ...
                    <td className="border">
                      <input
                        ...
                        onChange={(e) => handleIntetionChange(e, index)}
                        onFocus={(e) => handleActiveRow(e, index)}
                      />
                    </td>
                    ) : null}
                    ...
                    <td className="border">
                      <input
                        ...
                        className="appearance-none bg-transparent border-none w-full leading-tight focus:outline-none"
                        value={data.Boundary}
                        onChange={(e) => handleBoundaryChange(e, index)}
                        onFocus={(e) => handleActiveRow(e, index)}
                      />
                    </td>
                    ) : null}
                    ...
                    <td className="border">
                      <input
                        type="text"
                        className="appearance-none bg-transparent border-none w-full leading-tight focus:outline-none"
                        value={data.Design_Conditions}
                        onChange={(e) => handleDesignConditionChange(e, index)}
                        onFocus={(e) => handleActiveRow(e, index)}
                      />
                    </td>
                    ) : null}
                    ...
                    <td className="border">
                      <input
                        ...
                        onChange={(e) =>
                          handleOperatingConditionChange(e, index)
                        }
                        onFocus={(e) => handleActiveRow(e, index)}
                      />
                    </td>
