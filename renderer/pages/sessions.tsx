      ...
      <div className="container">
        <div className="row">
          ...
          <div className="w-5/6">
            ...
            <ButtonExportExcelSession
              DataJson={sessions}
              RelasiDataJson={members}
              NameFile={"Export_Session"}
            />
            {showError && (
              <div
              ...
              <thead className="bg-slate-300">
                <tr>
                  {columnVisibility?.Sessions_Children.Date ? (
                    <td className="border px-4 py-2 font-bold text-center">Date</td>
                  ) : null}
                  {columnVisibility?.Sessions_Children.Duration ? (
                    <td className="border px-4 py-2 font-bold text-center">Duration</td>
                  ) : null}
                  {columnVisibility?.Sessions_Children.Session ? (
                    <td className="border px-4 py-2 font-bold text-center">Session</td>
                  ) : null}
                  {columnVisibility?.Sessions_Children.Facilitator_ID ? (
                    <td className="border px-4 py-2 font-bold text-center">Facilitator</td>
                  ) : null}
                  {columnVisibility?.Sessions_Children.Scribe_ID ? (
                    <td className="border px-4 py-2 font-bold text-center">Scribe</td>
                  ) : null}
                  {columnVisibility?.Sessions_Children.Session_Comments ? (
                    <td className="border px-4 py-2 font-bold text-center">Comments</td>
                  ) : null}
                </tr>
              </thead>
              <tbody>
                    ...
                    {columnVisibility?.Sessions_Children.Scribe_ID ? (
                      <td className="border">
                        <select
                          ...
                          onChange={(e) =>
                            handleScribeChange(e.target.value, index)
                          }>
                          <option value={""}></option>
                          {members.map((member) => (
                            <option key={member.ID} value={member.ID}>
