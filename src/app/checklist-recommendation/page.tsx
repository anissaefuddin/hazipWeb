...
const ChecklistRecommendation: React.FC = () => {
  ...
  const handleActionPartyChange = (newValue: string, index: number) => {
    const updatedData = [...lopas];
    updatedData[index].Check_List_Recommendation_Responsible_Party = newValue;
    setLopa(updatedData);
    const dataApa = dataGlobal;
    dataApa.Check_List_Recommendations = lopas;
    updateDataGlobal(dataApa);
      ...
      <section className="section-sm">
        <div className="container">
          <div className="row">
            <div className="w-1/6">
              <ul>
                <li className="mb-4 lg:mb-2">
                  <Link href="/pha-recommendation" className="block hover:text-gray-900 font-medium text-gray-600" >
                    PHA Recommendation
                  </Link>
                </li>
                <li className="mb-4 lg:mb-2">
                ...
                <li className="mb-4 lg:mb-2">
                  <Link href="/checklist-recommendation" className="block hover:text-gray-900 text-lg text-black" >
            ...
            <div className="w-5/6">
              <h1>Check List Recommendation</h1>
              <button
                    ...
                    >
                      <td className="border">
                        <input
                          ...
                          value={data.Check_List_Recommendation}
                      ...
                      <td className="border">
                        <select
                          className="appearance-none bg-transparent border-none w-full leading-tight focus:outline-none"
                          value={data.Check_List_Recommendation_Responsible_Party}
                      ...
                      <td className="border">
                        <input
                          type="text"
                          className="appearance-none bg-transparent border-none w-full leading-tight focus:outline-none"
                          value={data.Check_List_Recommendation_Comments}
...
export default ChecklistRecommendation;
