        ...
        <div className="row">
            <div className="w-1/6">
              <ul>
                ...
                <li className="mb-4 lg:mb-2"><Link href="/lopa-recommendation" className="block hover:text-gray-900 text-lg text-black">LOPA Recommendation</Link></li>
          ...
          {lopas.map((data,index) => (
           <tr key={data.ID} className={activeRow === index ? 'active-row' : ''}>
             <td className='border-t border-b border-l'>{index+1}</td>
              ...
              <td className="border">
                <input type="text" className='appearance-none bg-transparent border-none w-full leading-tight focus:outline-none' 
                value={data.Lopa_Recommendation_Responsible_Party} onChange={(e) => handlePartyChange(e, index)} onFocus={(e) => handleActiveRow(e,index)}/>
              </td>
              <td className="border">
              <select className='appearance-none bg-transparent border-none w-full leading-tight focus:outline-none' 
