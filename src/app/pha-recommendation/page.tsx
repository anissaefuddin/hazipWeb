            ...
            <div className="w-1/6">
              <ul>
                <li className="mb-4 lg:mb-2">
                  <Link href="/pha-recommendation" className="block hover:text-gray-900 text-lg text-black" >
                    PHA Recommendation
                  </Link>
                </li>
                <li className="mb-4 lg:mb-2">
                  <Link href="/lopa-recommendation" className="block hover:text-gray-900 font-medium text-gray-600" >
                    LOPA Recommendation
                  </Link>
                </li>
                <li className="mb-4 lg:mb-2">
                  <Link href="/checklist-recommendation" className="block hover:text-gray-900 font-medium text-gray-600" >
                    ...
                    >
                      ...
                      <td className="border">
                        <select
                          ...
                          onChange={(e) =>
                            handlePriorityChange(e.target.value, index)
                          }
                        >
                          <option value={""}></option>
                      ...
                      <td className="border">
                        <select
                          ...
                          onChange={(e) =>
                            handleActionPartyChange(e.target.value, index)
                          }
                        >
                          <option value={""}></option>
                          {members.map((member) => (
                      ...
                      <td className="border">
                        <input
                          type="text"
                          className="appearance-none bg-transparent border-none w-full leading-tight focus:outline-none"
                          value={data.Pha_Recommendation_Comments}
