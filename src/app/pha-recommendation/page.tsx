    ...
    <PageHeader title="PHA Recommendation" />
      <section className="section-sm">
        ...
        <div className="row">
            <div className="w-1/6">
              <ul>
                <li className="mb-4 lg:mb-2"><a href="/pha-recommendation" className="block hover:text-gray-900 text-lg text-black">PHA Recommendation</a></li>
                ...
                <li className="mb-4 lg:mb-2"><a href="/checklist-recommendation" className="block hover:text-gray-900 font-medium text-gray-600">Check List Recommendation</a></li>
                </ul>
                </div>
            <div className="w-5/6">
