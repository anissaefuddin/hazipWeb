          ...
          <div className="row">
            <div className="w-1/6">
              <ul>
                ...
                <li className="mb-4 lg:mb-2">
                  <Link href="/concequences" className="block hover:text-gray-900 font-medium text-gray-600" >
                    Concequences Categorys
                  </Link>
                </li>
                <li className="mb-4 lg:mb-2">
                  <Link href="/risk-rankings" className="block hover:text-gray-900 text-lg text-black" >
                    Risk Ranking
                  </Link>
                </li>
              </ul>
                    ...
                    >
                      ...
                      <td className="border">
                        <input
                          type="text"
                          className="appearance-none bg-transparent border-none w-full leading-tight focus:outline-none"
                          value={data.Required_Lopa_Credits}
                          onChange={(e) => handleLOPAChange(e, index)}
                          onFocus={(e) => handleActiveRow(e, index)}
                        />
                      </td>
                    </tr>
