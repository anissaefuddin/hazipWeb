            ...
            <div className="w-1/6">
              <ul>
                <li className="mb-4 lg:mb-2">
                  <Link
                    href={"/overview"}
                    className="block hover:text-gray-900 font-medium text-gray-600"
                  >
                    Overview
                  </Link>
                </li>
                ...
                <li className="mb-4 lg:mb-2">
                  <Link
                    href={"/setting-columns"}
                    className="block hover:text-gray-900 text-lg text-black"
                  >
                    Setting Column
                  </Link>
                </li>
